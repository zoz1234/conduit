...
def create_article(browser):
    ...
    about_input = browser.find_element(By.XPATH, '//input[@class="form-control"]')
    article_text_input = browser.find_element(By.XPATH, '//textarea[@placeholder="Write your article (in markdown)"]')
    tags_input = browser.find_element(By.XPATH, '//input[@placeholder="Enter tags"]')
